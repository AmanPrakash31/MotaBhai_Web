...
import { suggestListingPrice } from '@/ai/flows/suggest-listing-price';
import { z } from 'zod';
...
export async function getSuggestedPrice(data) {
  ...
  try {
    const result = await suggestListingPrice(validation.data);
